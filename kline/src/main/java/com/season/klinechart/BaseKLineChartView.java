...
import com.season.klinechart.base.IAdapter;
...
import com.season.klinechart.formatter.TimeFormatter;
...
public abstract class BaseKLineChartView extends ScrollAndScaleView {
    ...
    private void init() {
        ...
        mSelectorFramePaint.setColor(getContext().getResources().getColor(R.color.chart_selector_line));
    }
