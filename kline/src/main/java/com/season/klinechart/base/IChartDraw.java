package com.season.klinechart.base;
...
public interface IChartDraw<T> {
     ...
     * @param curX      当前点的X坐标
     */
    void drawTranslated(T lastPoint, T curPoint, float lastX, float curX, Canvas canvas, BaseKLineChartView view, int position);
     ...
     * @param y        y的起始坐标
     */
    void drawText(Canvas canvas, BaseKLineChartView view, int position, float x, float y);
