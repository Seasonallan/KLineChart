...
import com.season.klinechart.draw.KDJDraw;
import com.season.klinechart.draw.MACDDraw;
import com.season.klinechart.draw.MainDraw;
import com.season.klinechart.draw.RSIDraw;
import com.season.klinechart.draw.VolumeDraw;
import com.season.klinechart.draw.WRDraw;
...
public class KLineChartView extends BaseKLineChartView {
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        if (array != null) {
            try {
                ...
                mMainDraw.setSelectorTextColor(array.getColor(R.styleable.KLineChartView_kc_text_color, getColor(R.color.chart_white)));
                ...
                setSelectedXLineColor(getColor(R.color.chart_selector_line));
                ...
                setSelectorBackgroundLineColor(array.getColor(R.styleable.KLineChartView_kc_selector_background_line_color, getColor(R.color.chart_selector_line)));
    ...
    public void setSelectorBackgroundLineColor(int color) {
        mMainDraw.setSelectorBackgroundLineColor(color);
    }
