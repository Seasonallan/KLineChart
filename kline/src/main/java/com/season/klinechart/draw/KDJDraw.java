...
import com.season.klinechart.entity.IKDJ;
...
public class KDJDraw implements IChartDraw<IKDJ> {
    ...
    @Override
    public void drawTranslated(IKDJ lastPoint, IKDJ curPoint, float lastX, float curX, Canvas canvas, BaseKLineChartView view, int position) {
        if (lastPoint.getK() != 0) {
